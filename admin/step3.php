...
//No. Of Winners
  ...
  ?>
<div classs="luckydrawformcontainer" style="background-color:Red;width:60%;float:left;">
  ...
  <div class="col-2 mt-3">
          <label for="validationServer01" class="form-label">Box Color</label>
...
<div class="luckydrawformright">
  <div id="luckydrawformnote"><i>
            ...
            <?php Lucky_Draw_Plugin_Path.'includes/preview.php'; ?>
  </div>
</div>
<?php } ?>
